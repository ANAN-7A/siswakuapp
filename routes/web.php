...
Route::get('siswa', 'SiswaController@index');//1
...
route::get('siswa/create', 'SiswaController@create');//2

route::get('siswa/{siswa}', 'SiswaController@show');//3

route::post('siswa', 'SiswaController@store');//4
